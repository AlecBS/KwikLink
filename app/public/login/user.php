...
$pgHtm = wtkLoadInclude($pgPath . 'user.htm');
// BEGIN Show link to see QR Code of personal URL
$pgPersonalURL = wtkSqlValue('PersonalURL');
if ($pgPersonalURL != ''):
    $pgQRlink = 'Schedule Meeting: <a class="btn btn-floating" onclick="JavaScript:ajaxGo(\'/login/showQRcode\')"><img src="/imgs/qr_code.svg" style="margin-top:7px"></a>';
